...
////////// PROBLEM 1 //////////
/*
  Create a variable named 'firstItem' and set it 
  equal to the first value of the 'arr' array.
*/
...
/*
  ...
  Console.log the array to verify you no 
...
// } 
//Note: this solution will log evensArr with each for loop
...
/*
  ...
  equal to the fifth value of the 'myFavoriteNumbers' array.
*/
...
//   console.log(letters)
// }
// will log array 5 times

//let i = (letters.length -1) so that starting point is at last index
// set condition to stop once loop accounts for 0 index
// decrementor so loop enters array from ending point
for (let i = (letters.length -1); i >= 0 ; i--){
  console.log(letters)
}
